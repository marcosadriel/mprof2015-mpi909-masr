	...
	<body>
		...
		<div id="show-tarefa" class="content scaffold-show" role="main">
			...
			<ol class="property-list tarefa">
				...
				<g:if test="${tarefaInstance?.completo}">
				<li class="fieldcontain">
					<span id="completo-label" class="property-label"><g:message code="tarefa.completo.label" default="Completo" /></span>
					
						<span class="property-value" aria-labelledby="completo-label"><g:formatBoolean boolean="${tarefaInstance?.completo}" /></span>
